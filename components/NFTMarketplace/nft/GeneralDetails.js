...
const style = {
  ...
  accent: `text-[#fb8a25] text-[1.1rem] font-normal`,
  nftTitle: `text-3xl font-extrabold text-black`,
  otherInfo: `flex`,
  ownedBy: `text-[#8a939b] mr-4 font-bold`,
  likes: `flex items-center text-[#FFFFFF]`,
  likeIcon: `mr-1`,
    ...
    return (
        <div className={style.wrapper}>
            <div className={style.infoContainer}>
               <div className={style.accent}>{selectedNft?.collections}</div>
               <div className={style.nftTitle}>{selectedNft?.name}</div>
                <div className={style.otherInfo}>
                    <div className={style.ownedBy}>
                        Owned by <span className={style.accent}>Nermine</span>
                    </div>  
